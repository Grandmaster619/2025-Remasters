...
# Added some unused textures to the game including arrow signs, seashells, storm rocks, and jungle tiles

# Changed controls so that Space could be pressed to jump

# Removed options button from Pause Menu (there weren't any options)

# Fixed the hitboxes for trees so the player couldn't get stuck in jank colliders

# Prevented softlocks

# Added more tunnels and places to go

# Created an ending to the game

# Fixed UI scaling in title screen

# Fixed tiling in underground areas
